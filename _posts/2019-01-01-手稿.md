...
sudo docker run --link redis-master:redis-master -v /home/forgeeks/Documents/redis/redis.conf:/usr/local/etc/redis/redis.conf --name redis-slave1 -d redis redis-server /usr/local/etc/redis/redis.conf

sudo docker run --link redis-master:redis-master -v /home/forgeeks/Documents/redis/redis.conf:/usr/local/etc/redis/redis.conf --name redis-slave2 -d redis redis-server /usr/local/etc/redis/redis.conf

sudo docker run --link redis-master:redis-master -v /home/forgeeks/Documents/redis/redis.conf:/usr/local/etc/redis/redis.conf --name redis-slave3 -d redis redis-server /usr/local/etc/redis/redis.conf
...
>>>>>>> b80ac72937a325d85e6b8cbd815171db9e4ea296
